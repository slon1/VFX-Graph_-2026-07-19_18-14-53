...
[TestFixture]
public class Fluid2DWorldSmokeTests
{
    ...
    public void SetUp()
    {
        host = new GameObject("SimWorld_Fluid2D_Smoke");
        host.SetActive(false);

        EffectAsset asset = AssetDatabase.LoadAssetAtPath<EffectAsset>(AssetPath);
        Assert.IsNotNull(asset, "run Tools/M3D/Create Fluid2D Effect");
    ...
    [Test]
    public void Rebuild_ProductionFluid2DAsset_DoesNotThrow()
    {
