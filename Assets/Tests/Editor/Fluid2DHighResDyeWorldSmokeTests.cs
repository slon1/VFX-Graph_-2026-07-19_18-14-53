...
[TestFixture]
public class Fluid2DHighResDyeWorldSmokeTests
{
    ...
    public void SetUp()
    {
        host = new GameObject("SimWorld_Fluid2D_HighResDye_Smoke");
        host.SetActive(false);

        EffectAsset asset = AssetDatabase.LoadAssetAtPath<EffectAsset>(AssetPath);
        Assert.IsNotNull(asset, "run Tools/M3D/Create Fluid2D HighResDye Experiment");
    ...
    [Test]
    public void Rebuild_HighResDyeAsset_DoesNotThrow()
    {
