...
[TestFixture]
public class Fluid2DVorticityWorldSmokeTests
{
    ...
    public void SetUp()
    {
        host = new GameObject("SimWorld_Fluid2D_Vorticity_Smoke");
        host.SetActive(false);

        EffectAsset asset = AssetDatabase.LoadAssetAtPath<EffectAsset>(AssetPath);
        Assert.IsNotNull(asset, "run Tools/M3D/Create Fluid2D Vorticity Experiment");
    ...
    [Test]
    public void Rebuild_VorticityAsset_DoesNotThrow()
    {
