...
Аддитивно к M2c. Kernel IDs Du/Dv/F/k — private в классе (не `SimShaderIds`). N=1–4 `GrayScottPass` за кадр — doc-рекомендация при Speed=1. Вне скоупа: demo EffectAsset, agent→V P2G, wraparound, runtime CFL guard, LUT/trail (M2d).
