...
| Тема | Сейчас |
| --- | --- |
| Stable Fluids (Stam-minimum + F2 скоуп) | F1 закрыта ([ADR-019](ADR/ADR-019-Fluid2D-Solver.md)). F2.0–F2.1b закрыты ([ADR-026](ADR/ADR-026-F2-Small-Scale-Structure.md)); дальше limited MacCormack dye (scratch, не Role C). MAC / F0.5 / viscosity вне фазы |
